...
urlpatterns = [
    ...
    path("sector/<int:pk>/estantes/imprimir/", imprimir_estantes, name="imprimir_estantes"),
    path("sector/<int:pk>/corredor/<str:corredor>/", corredor_detail, name="corredor_detail"),
    path("sector/<int:pk>/corredor/<str:corredor>/estante/<str:estante>/", estante_detail, name="estante_detail"),
