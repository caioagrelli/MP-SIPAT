...
urlpatterns = [
    ...
    path('relatorios/gastos-por-item/', gastos_por_item, name='gastos_por_item'),
    path('relatorios/gastos-por-item/exportar/', gastos_por_item_export_xlsx, name='gastos_por_item_export_xlsx'),
